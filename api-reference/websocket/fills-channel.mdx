...
The [Orders Channel](./orders-channel.mdx) tells you *that* an order filled and how
...
(see [Place Order](../orders/place-order.mdx)), the engine encrypts each change amount
