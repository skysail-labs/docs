...
The [Orders Channel](./orders-channel.md) tells you *that* an order filled and how
...
(see [Place Order](../orders/place-order.md)), the engine encrypts each change amount
