...
* [Overview](get-started/overview.mdx) — what Darknyx is and how the venue fits together.
* [Programmatic Access](get-started/programmatic-access.mdx) — the REST + WebSocket API at a glance.
* [TypeScript Client](sdk/typescript-client.mdx) — authenticate, build orders, stream fills.
