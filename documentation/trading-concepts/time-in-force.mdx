...
emitted on the [Orders Channel](/api-reference/websocket/orders-channel).
...
[Order Types](./order-types.mdx) for how the type controls resting, and
[Execution Attributes](./execution-attributes.mdx) for fill-size constraints.
</Info>
