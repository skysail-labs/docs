...
price** anchored to the market's oracle (see [Clearing Price](./clearing-price.mdx)).
...
[Execution Attributes](./execution-attributes.mdx).
...
See [Order Compatibility](./order-compatibility.mdx) for which combinations of type,
