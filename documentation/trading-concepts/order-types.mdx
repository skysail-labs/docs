...
price** anchored to the market's oracle (see [Clearing Price](./clearing-price.md)).
...
[Execution Attributes](./execution-attributes.md).
...
See [Order Compatibility](./order-compatibility.md) for which combinations of type,
